...
public class IndexUtils {
			...
			ConstructPageException
	{
		...
		if (selects[2] == null) {
			...
			// Interval Index Scan fix this.--- /// TODO revert if it fails
			if (selects[0].op.attrOperator == AttrOperator.aopGT) {
				...
				// aopAD
			if (selects[0].op.attrOperator == AttrOperator.aopAD || selects[0].op.attrOperator == AttrOperator.aopCP  /*|| selects[0].op.attrOperator == AttrOperator.aopCP*/) { //TODO- change here
				if (selects[0].type1.attrType != AttrType.attrSymbol) {
